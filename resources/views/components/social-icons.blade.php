<div {{ $attributes->class(['flex items-center']) }}>
    <a
       href="https://web.facebook.com/joseosvaldo.morillovillar"
       class="
       w-10
       h-10
       flex
    ...
    <a
       href="https://twitter.com/Joseomv"
       class="
       w-10
       h-10
       flex
    ...
    <a
       href="https://www.youtube.com/channel/UCA7r_X2XwnmRbQZ-vwzTaNg"
       class="
       w-10
       h-10
       flex
    ...
    <a
       href="https://www.linkedin.com/in/jose-osvaldo-morillo-villar-a9b92b11/"
       class="
       w-10
       h-10
       flex
